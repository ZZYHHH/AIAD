...
public class DragGridView extends GridView {
    ...
    private long dragRespondTime = 1000;//长按视为拖动图标
    private int mDownX, mDownY;  //手指按下的点坐标
    private int moveX, moveY;//手指移动的距离
    private int mPoint2ItemTop, mPoint2ItemLeft;//手指按下坐标到该item的边缘偏移值
    private int mStartUpScrollHeight, mStartDownScrollHeight;//开始自动滚动的高度
    private int mStatusHeight = 0;//状态栏高度
    private int mOffsetTop, mOffsetLeft;//手指按下坐标到屏幕边框的偏移值
    private int mDragPosition = 0;//手指按下的position
    private View mStartDragItemView;//手指按下的view
    private Bitmap mDragBitmap;//镜像view
    private ImageView mDragImageView;//镜像imageview组件
    WindowManager.LayoutParams winLayoutParams;
    private boolean isDrag = false;//是否支持拖动界面
